...
module.exports = (grunt) => {
    return {
        ...
        'manifest': {
            files: {
                './': ['build/reliable-web-summit-2021/browser/ngsw.json']
            },
            options: {
                patterns: [
                    {
                    ...
                    },
                    {
                        ...
                        replacement: (_, filename) => {
                            return `"/reliable-web-summit-2021/browser/${filename}.html": "${computeHashOfFile(
                                `build/reliable-web-summit-2021/browser/${filename}.html`,
                                'sha1',
                                'hex'
                            )}"`;
                        }
