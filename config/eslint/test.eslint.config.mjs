...
export default defineConfig([
    ...
    },
    {
        files: ['**/*.ts'],
        rules: {
            '@angular-eslint/component-selector': ['error', { prefix: 'rws', style: 'kebab-case', type: 'element' }],
            '@angular-eslint/directive-selector': ['error', { prefix: 'rws', style: 'camelCase', type: 'attribute' }],
