...
describe('/', () => {
    ...
    it('should display the correct headline', async () => {
        ...
        expect(await page.getHeadline()).toEqual('Keep running\nat runtime');
    });
    ...
    it('should go to the next slide', async () => {
        ...
        await element(by.tagName('body')).sendKeys(Key.ARROW_RIGHT, Key.ARROW_RIGHT, Key.ARROW_RIGHT, Key.ARROW_RIGHT, Key.ARROW_RIGHT);
